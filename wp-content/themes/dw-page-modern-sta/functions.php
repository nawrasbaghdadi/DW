...
if ( !function_exists('dw_page_display_section') ){
    ...
    <section id="<?php echo sanitize_title($title); ?>" class="section <?php echo $classes ?>">
        <div class="flicker-example" data-block-text="false">
            <div class="main-title"><img src="<?php echo get_template_directory_uri(''); ?>/assets/img/logo-m.png" alt="Magnets"/></div>
        
        <ul>
            
            <li data-background="<?php echo get_template_directory_uri(''); ?>/assets/imgz/home.jpg">
                <div class="flick-title">Magnets</div>
                <div class="flick-sub-text">Welcome to “MAGNETS”, the future of your business</div>
            </li>
            
            <li data-background="<?php echo get_template_directory_uri(''); ?>/assets/imgz/massage.jpg">
                <div class="flick-title">Magnets Pr</div>
                <div class="flick-sub-text">Your messages, our passion ,
                    360° communications hub</div>
            </li>
            
            <li data-background="<?php echo get_template_directory_uri(''); ?>/assets/imgz/branding.jpg">
                <div class="flick-title">Magnets branding</div>
                <div class="flick-sub-text">We put our creativity to work to make you different, unique and memorable.</div>
            </li>
            <li data-background="<?php echo get_template_directory_uri(''); ?>/assets/imgz/events.jpg">
                <div class="flick-title">Magnets events</div>
                <div class="flick-sub-text">Let us make your upcoming event a stunning success</div>
            </li>
            <li data-background="<?php echo get_template_directory_uri(''); ?>/assets/imgz/mdia-traning.jpg">
                <div class="flick-title">Magnets media Training</div>
                <div class="flick-sub-text">Best media training in the Middle East region</div>
            </li>
            
        </ul>
        <div class="scroller"><div class="arrow-downs"><img src="<?php echo get_template_directory_uri(''); ?>/assets/img/arrow-down.png"/></div>SCROLL<span>DOWN</span></div>
