...
<script  type="text/JavaScript" src="<?php echo get_template_directory_uri(''); ?>/assets/js/jquery.finger.js" ></script>
<script  type="text/JavaScript" src="<?php echo get_template_directory_uri(''); ?>/assets/js/flickerplate.js" defer></script>
